...
const listings = [
  {
    ...
    price: 120,
    images: [
      "https://via.placeholder.com/200x150?text=Nike+Air+Max+1",
      "https://via.placeholder.com/200x150?text=Nike+Air+Max+2"
    ]
  },
  {
    id: "2",
    title: "MacBook Pro",
    description: "Apple laptop 16-inch",
    price: 2400,
    images: [
      "https://via.placeholder.com/200x150?text=MacBook+Front",
      "https://via.placeholder.com/200x150?text=MacBook+Side"
    ]
  }
];
